    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_type == 'dispatcher') {?>
          <li><a href="?page=map_view"><i class="fa fa-map-marker"></i> <span>View Patrol Teams</span></a></li>
          <li><a href="?page=generate_report"><i class="fa fa-bar-chart"></i> <span>Generate Reports</span></a></li>
          <li><a href="?page=make_ann"><i class="fa fa-bullhorn"></i> <span>Make Announcement</span></a></li>
        <?php } elseif($user_type == 'secretariat representative') { ?>
          <li><a href="?page=list_personnel"><i class="fa fa-tasks"></i> <span>Manage Personnel</span></a></li>
          <li><a href="?page=view_dep_plan"><i class="fa fa-calendar"></i> <span>Manage Deployment Plans</span></a></li>
          <li><a href="?page=manage_patrol_team"><i class="fa fa-car"></i> <span>Manage Patrol Team</span></a></li>
          <li><a href="?page=generate_report"><i class="fa fa-bar-chart"></i> <span>Generate Reports</span></a></li>
          <li><a href="?page=make_ann"><i class="fa fa-bullhorn"></i> <span>Make Announcement</span></a></li>
        <?php } elseif($user == 'admin') { ?>
          <li><a href="?page=list_personnel"><i class="fa fa-tasks"></i> <span>Manage Personnel</span></a></li>
          <li><a href="?page=view_dep_plan"><i class="fa fa-calendar"></i> <span>Manage Deployment Plans</span></a></li>
          <li><a href="?page=man_sec"><i class="fa fa-users"></i> <span>Manage Secretariat</span></a></li>
          <li><a href="?page=man_users"><i class="fa fa-user"></i> <span>Manage Users</span></a></li>
          <li><a href="?page=manage_patrol_team"><i class="fa fa-car"></i> <span>Manage Patrol Team</span></a></li>
          <li><a href="?page=map_view"><i class="fa fa-map-marker"></i> <span>View Patrol Teams</span></a></li>
          <li><a href="?page=generate_report"><i class="fa fa-bar-chart"></i> <span>Generate Reports</span></a></li>
          <li><a href="?page=make_ann"><i class="fa fa-bullhorn"></i> <span>Make Announcement</span></a></li>
          <?php // } elseif($user == 'sys_admin') { ?>
            ...
            <li><a href="?page=view_dep_plan"><i class="fa fa-link"></i> <span>View Deployment Plan</span></a></li-->
          <?php } ?>
          <li><a href="?page=log_out"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
